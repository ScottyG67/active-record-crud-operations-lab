...
def can_be_found_updated_and_saved
  ...
  Movie.find_by_title("Awesome Flick").update(title: "Even Awesomer Flick")
  #__
  Movie.find_by_title("Even Awesomer Flick")
end

def can_update_using_update_method
  # Update movie title to "Wat, huh?"
  Movie.create(title: "Wat?")
  Movie.find_by_title("Wat?").update(title: "Wat, huh?")
end
...
def can_update_multiple_items_at_once
  ...
  Movie.where("title LIKE ? AND release_date LIKE ?","Movie_%","200%").update_all(title: "A Movie")
end
